    ...
    return (
        <div className="flex flex-wrap items-center justify-center">
            {forecastData && forecastData.map((dayData, index) => (
                <div 
                    key={index} 
                    className="flex flex-col items-center w-1/2 p-2 text-lg font-semibold sm:w-1/3 md:w-1/4 lg:w-1/6"
                >
                    ...
                    <div className="text-xl font-bold text-white md:text-2xl lg:text-3xl">
